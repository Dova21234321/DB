...
class Main_Window():
    def __init__(self):
        ...
        self.ref_menu.add_command(label="")
        self.ref_menu.add_command(label="Места издания")
        self.ref_menu.add_command(label="Авторы")
        self.ref_menu.add_command(label="Жанры")

        self.book_menu.add_command(label='Поступление материалов')
        self.book_menu.add_command(label='Список материалов')
        self.book_menu.add_command(label='Продажа материалов')
        ...
        self.main_menu.add_cascade(label="Материалы", menu=self.book_menu)
