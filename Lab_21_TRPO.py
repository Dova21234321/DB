...
class Main_Window():
    ...
    def __init__(self):
        ...
        self.material_menu.add_command(label='Поступление материалов')
        self.material_menu.add_command(label='Список материалов')
        self.material_menu.add_command(label='Продажа материалов')
